...
- **DNS monitoring** — checks A, AAAA, CNAME, MX, TXT, and NS records with optional expected-value validation
- **gRPC health check** — probes a gRPC Health service endpoint by service name and method
